...
; void SaveContext(stackPointer, address)  
SaveContext:
  ; R0 = Stack pointer saved on expection entry
  ; R1 = Address where the context should be saved
  ; R2 = Work area
  PUSH {R0,R1,R2,LR}
